    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="text-center">
                <h1 className="text-5xl font-bold text-white mb-4">About DataAnalyzer</h1>
            ...
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700">
                <h2 className="text-2xl font-bold text-white mb-4">What is DataAnalyzer?</h2>
            ...
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Multiple File Formats</h3>
                            <p className="text-dark-400 text-sm">Support for CSV and Excel (XLSX) files</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Rich Chart Types</h3>
                            <p className="text-dark-400 text-sm">Scatter, Line, Bar, Histogram, and Box Plot charts</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-dark-400 text-sm">Handle large datasets with WebWorker processing</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-dark-400 text-sm">All processing happens in your browser - no data leaves your device</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Interactive Controls</h3>
                            <p className="text-dark-400 text-sm">Dynamic filtering, zooming, and data exploration</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Export Charts</h3>
                            <p className="text-dark-400 text-sm">Download your visualizations as high-quality images</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Why DataAnalyzer */}
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700">
                <h2 className="text-2xl font-bold text-white mb-4">Why DataAnalyzer?</h2>
                <div className="space-y-4">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">🔒 Your Data Stays Yours</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">⚡ Fast and Efficient</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
            ...
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        ...
                        <div className="text-dark-400 text-xs">UI Framework</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">📘</div>
                        <div className="text-white font-semibold text-sm">TypeScript</div>
                        <div className="text-dark-400 text-xs">Type Safety</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">📊</div>
                        <div className="text-white font-semibold text-sm">ECharts</div>
                        <div className="text-dark-400 text-xs">Visualization</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">🎨</div>
                        <div className="text-white font-semibold text-sm">Tailwind CSS</div>
                        <div className="text-dark-400 text-xs">Styling</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">⚡</div>
                        <div className="text-white font-semibold text-sm">Vite</div>
                        <div className="text-dark-400 text-xs">Build Tool</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">🐻</div>
                        <div className="text-white font-semibold text-sm">Zustand</div>
                        <div className="text-dark-400 text-xs">State Management</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">📦</div>
                        <div className="text-white font-semibold text-sm">SheetJS</div>
                        <div className="text-dark-400 text-xs">Excel Parsing</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-lg p-4 text-center">
                        <div className="text-2xl mb-2">👷</div>
                        <div className="text-white font-semibold text-sm">Web Workers</div>
