        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a
                    ...
                    className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700 hover:border-primary-500 transition-colors group"
                >
                    <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-dark-400 text-sm">Report issues or contribute</p>
                        </div>
                    </div>
                ...
                <div className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700">
                    <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-dark-400 text-sm">For general inquiries</p>
                        </div>
                    </div>
            ...
            <div className="bg-dark-800/50 backdrop-blur-sm rounded-2xl p-8 border border-dark-700">
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="text-white font-semibold mb-2">Is DataAnalyzer really free?</h3>
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">How large can my dataset be?</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">Can I use DataAnalyzer offline?</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">How can I contribute to the project?</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">Can I export my charts?</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-white font-semibold mb-2">Do you offer commercial support?</h3>
                        <p className="text-dark-300 text-sm leading-relaxed">
