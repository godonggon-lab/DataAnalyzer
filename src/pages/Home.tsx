...
const Home = () => {
    ...
    return (
        <>
            <SEO 
                title="DataAnalyzer - Free CSV & Excel Data Visualization Tool"
                description="Transform your CSV and Excel files into beautiful charts and insights. Free online data analysis tool. No installation required. Your data stays secure in your browser."
                keywords="CSV viewer, Excel analyzer, data visualization, free data tool, chart maker, data analytics, spreadsheet viewer, CSV to chart, online data analysis"
                ogUrl="https://freedataanalyzer.com"
            />
