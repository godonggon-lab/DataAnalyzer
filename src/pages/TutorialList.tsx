        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-dark-800/50 backdrop-blur-sm rounded-xl p-6 border border-dark-700 text-center">
                    <div className="text-3xl font-bold text-primary-400 mb-2">{tutorials.length}</div>
                    <div className="text-dark-400 text-sm">Tutorials Available</div>
                </div>
                <div className="bg-dark-800/50 backdrop-blur-sm rounded-xl p-6 border border-dark-700 text-center">
                    <div className="text-3xl font-bold text-primary-400 mb-2">37 min</div>
                    <div className="text-dark-400 text-sm">Total Learning Time</div>
                </div>
                <div className="bg-dark-800/50 backdrop-blur-sm rounded-xl p-6 border border-dark-700 text-center">
                    <div className="text-3xl font-bold text-primary-400 mb-2">100%</div>
                    <div className="text-dark-400 text-sm">Free Content</div>
                </div>
            </div>
